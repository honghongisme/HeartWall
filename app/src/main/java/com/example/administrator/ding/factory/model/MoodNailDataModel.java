...
import com.example.administrator.ding.bean.MoodBadNail;
import com.example.administrator.ding.bean.MoodGoodNail;
...
public class MoodNailDataModel {
     ...
     * @return
     */
    public int[] getNormalImageSizeByRes(int res) {
