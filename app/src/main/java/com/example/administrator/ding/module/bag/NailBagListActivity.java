...
public class NailBagListActivity extends SimpleActivity implements ExpandableListView.OnChildClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nail_bag_list);
        mContext = this;
    ...
    protected void initData() {
        ...
        model = new NailListDataModel(this);

        expandableListView = findViewById(R.id.expand_list);
        expandableListView.setOnChildClickListener(this);
        adapter = new ListAdapter(this, groupTitles, getData(), notFinishNum);
    ...
    private void showListenerNailDetailsDialog(final String firstDate, final String firstRecord) {
        BrowerInfoDialog dialog = new BrowerInfoDialog(mContext);
        dialog.show();
        ...
        dialog.setOnGoNailClickListener(new BrowerInfoDialog.OnGoNailClickListener() {
            ...
            public void onClick() {
                if(NetStateCheckHelper.isNetWork(mContext)) {
                    ...
                    final EditInfoDialog editInfoDialog = new EditInfoDialog(mContext);
                    editInfoDialog.show();
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        if(groupPosition == PLAN_GROUP_POSITION) {
            ...
            Intent i = new Intent(mContext, LookCommentDetailActivity.class);
