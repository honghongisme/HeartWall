...
public class ArcMenu extends ViewGroup implements OnClickListener {
     ...
     * 菜单主按钮回调接口
     */
    private OnMenuMainBtnClickListener onMenuMainBtnClickListener;
    /**
     * 中间主按钮
     */
    View cButton;
    ...
    public ArcMenu(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ArcMenu);
        a.getResourceId(R.styleable.ArcMenu_main_btn_img, R.drawable.ic_add);
        a.recycle();
        mContext = context;
        addMainButton();
    }
   ...
   //         layoutChildButtonToggleMenu(300);
    ...
    public View getChildMenuView(int resoureceId, String title, String extraInfo) {
        ...
        tvTitle.setTextColor(Color.parseColor("#4C4B4B"));
    ...
    public void onClick(View v) {
        ...
        onMenuMainBtnClickListener.onClick();
        layoutChildButtonToggleMenu(300);
    }
 ...
 //       setBackgroundColor(Color.parseColor("#66111111"));
    ...
    private void toggleMenuAnim(int durationMillis, final int i, final View childView, float viewX, float viewY) {
        ...
        childView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                onMenuItemLongClickListener.onLongClickItem(childView, i);
                //这里return true表示消费此事件，不再向下传递到OnClickListener
                return true;
            }
        });
    ...
    public interface OnMenuMainBtnClickListener {
        void onClick();
    }

    public void setOnMenuMainBtnClickListener(OnMenuMainBtnClickListener onMenuMainBtnClickListener) {
        this.onMenuMainBtnClickListener = onMenuMainBtnClickListener;
    }
